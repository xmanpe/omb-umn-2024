const DaftarFaq = {
  "daftar-faq-omb": [
    ...
    },
    {
      ...
      jawaban: "Seluruh peserta <b>wajib</b> mengikuti dan memperhatikan tahapan berikut ini: <br><ul><li>Pastikan koneksi internet dalam lancar.</li><li>Ukuran maksimal <i>file</i> dibawah 100 MB dan tidak lebih.</li><li><i>File</i> wajib berbentuk PDF.</li><li>Apabila masih berkendala, silakan coba untuk me-refresh halaman kembali dan mengisi ulang formulir.</li></ul> Jika sudah mengikuti dengan benar tetapi tetap tidak ada hasil, silakan menghubungi <b>LINE OA (@yqq6359s)</b> atau <b>WhatsApp (085179959923)</b> dengan screenshot sebagai bukti pendukung.",
      tipe: [0],
    },
    {
      pertanyaan: "Apa saja syarat untuk mengikuti OMB UMN 2023?",
      jawaban: "Peserta <b>wajib</b> melakukan beberapa persyaratan berikut ini: <ul><li>Mengumpulkan dan mengisi formulir lembar persetujuan keikutsertaan yang terdapat di halaman utama website resmi OMB UMN 2023.</li><li>Mengisi formulir riwayat kesehatan yang terdapat pada surat edaran rektorat.</li><li>Menyelesaikan kewajiban registrasi ulang kepada pihak kampus.</li></ul> Apabila terdapat kendala atau pertanyaan terkait registrasi ulang, silakan langsung menghubungi <b>WhatsApp marketing UMN (081286224155).</b>",
      tipe: [0],
    },
    {
      pertanyaan: "Apa saja tata cara mengikuti OMB UMN 2023 luring?",
      jawaban: "Peserta <b>wajib</b> untuk mencermati tata cara mengikuti OMB UMN 2023 luring: <ul><li>Wajib datang tepat waktu dan mengikuti rangkaian kegiatan OMB UMN 2023 dari awal hingga akhir.</li><li>Wajib mempersiapkan dan membawa barang-barang yang dibutuhkan dalam mengikuti rangkaian kegiatan OMB UMN 2023.</li></ul>",
      tipe: [0],
    },
    // Peraturan
    {
