    ...
    "BIMASENA": [
        {
            ...
            participants: [
                ...
                {name: "Theola Alvarizka", nim: "000000103328"},
                ...
                {name: "Lia Priyatiningrum", nim: "000000110571"},
                ...
                {name: "Muhammad Sulthan", nim: "000000108768"},
                {name: "Kheisha Twyla", nim: "00000078386"},
                {name: "Mohamad Vidie", nim: "00000099848"},
                {name: "Raffael Valentino", nim: "00000091170"},
                {name: "Ryane Kalyana", nim: "000000112449"},
                {name: "Glend Yesaya", nim: "000000105712"},
                {name: "Kayfa Razqia", nim: "000000104933"},
    ...
    "GAJENDRA": [
        {
            ...
            participants: [
                ...
                {name: "Koong Hiap", nim: "000000551360"},
                ...
                {name: "Ananda Refi", nim: "00000230783"},
    ...
    "SAKHA": [
        {
            ...
            participants: [
                ...
                {name: "Kayla Abbiegail", nim: "00000099531"},
                ...
                {name: "Charmaine Astrella", nim: "00000106229"},
                ...
                {name: "Eugenia Fidella", nim: "0000082450"},
                {name: "Felix Octaniel", nim: "0000101926"},
                {name: "Rehuel Tisya", nim: "0000091613"},
                {name: "Angeliqe Isabel", nim: "0000078290"},
                {name: "Felicia Mardjuki", nim: "0000099081"},
                {name: "Georgerius Ricardo", nim: "0000096120"},
                {name: "Tirtayani Padmasari", nim: "0000091606"},
                {name: "Melvie Ho", nim: "0000067626"},
                {name: "Valencia Fiorentina", nim: "0000095928"},
                {name: "Vito Nathayo", nim: "0000103332"},
                {name: "Sean Rizkiardy", nim: "0000107931"},
                {name: "Az Zahra Aulia", nim: "0000106379"},
                {name: "Jenice Aurelia", nim: "0000091157"},
                {name: "Felita Aileen", nim: "0000070576"},
                {name: "Graciella Nathania", nim: "0000090217"},
                {name: "Christian Yoga", nim: "0000067471"},
                {name: "Sharly Pravda", nim: "0000106793"},
                {name: "Chairin Thamrin", nim: "0000098028"},
                {name: "Fenny Caroline", nim: "0000089156"},
                {name: "Rafi Raditya", nim: "0000095315"},
                {name: "Callista Jasmine", nim: "0000110963"},
                {name: "Amanda Citra", nim: "0000092786"},
                {name: "Carmella Fitrya", nim: "0000104407"},
                {name: "Jonathan Suryajaya", nim: "0000091082"},
                {name: "Richie Giansanto", nim: "0000076847"},
                {name: "Ronald Ramlian", nim: "0000079786"},
                {name: "Angellie", nim: "0000092359"},
                {name: "Kevin Thenggano", nim: "0000100980"},
                {name: "Audrey Naoko", nim: "0000093171"},
                {name: "Gavrila Liona", nim: "0000093803"},
                {name: "Joycelyn Sharon", nim: "0000084354"},
                {name: "Yuliani", nim: "0000093306"},
                {name: "Benedictus Agsel", nim: "0000106221"},
                {name: "Michelle Fernanda", nim: "0000080229"},
                {name: "Melvin Tristan", nim: "0000074745"},
                {name: "Carolyne Kyneisha", nim: "0000076919"},
                {name: "Jeremy Dominic", nim: "0000103941"},
                {name: "Natan Adi", nim: "0000079860"},
                {name: "Brandon Sachio", nim: "0000092240"},
                {name: "Jolin Stefanie", nim: "0000093600"},
                {name: "Marvella Charissa", nim: "0000100819"},
                {name: "Eugenia Sunako", nim: "0000105184"},
                {name: "Airin Frantrishia", nim: "0000093892"},
                {name: "Abigail Vania", nim: "0000076945"},
                {name: "Wilson Roblens", nim: "0000077708"},
                {name: "Kezia Laurencia", nim: "0000094936"},
                {name: "Kezia Graciella", nim: "0000093057"},
                {name: "Kiev Immanuel", nim: "0000072670"},
                {name: "Aryabell Boston", nim: "0000104031"},
                {name: "Daniel Gouwardi", nim: "0000081820"},
                { name: "Celvin Cristyanto", nim: "0000069280" },
                { name: "Aisyah Luviola", nim: "0000098520" },
                { name: "Muhammad Iqbal", nim: "0000110573" },
                { name: "Zahwa Marliana", nim: "0000109449" },
                { name: "Abel Oktavian", nim: "0000093793" },
                { name: "Betrand Cornelius", nim: "0000082447" },
                { name: "Rafael Nicholas", nim: "0000092399" },
                { name: "Angelica Meideline", nim: "0000093193" },
                { name: "Umi Salamah", nim: "0000110843" },
                { name: "Yudith Rahmadiah", nim: "0000112859" },
                { name: "Elena Coarin", nim: "0000092274" },
                { name: "Angeline Kayla", nim: "0000099531" },
                { name: "Alexander Briant", nim: "0000099774" },
                { name: "Feri Rifki", nim: "0000114030" },
                { name: "Melda Rantika", nim: "0000107813" },
                { name: "Wizart Keane", nim: "0000080983" },
                { name: "Dylan Ervian", nim: "0000075730" },
                { name: "Christalin Barbietta", nim: "0000090339" },
                { name: "Chellensya Beatrice", nim: "0000101008" },
                { name: "Axel Leopulisa", nim: "0000101531" },
                { name: "Filbert Fausto", nim: "0000068593" },
                { name: "William Kwok", nim: "0000082480" },
                { name: "Marvell Wijaya", nim: "0000093796" },
                { name: "Patricia Huang", nim: "0000109227" },
                { name: "Rio Hawari", nim: "0000109470" },
                { name: "Alya Virgia", nim: "0000111025" },
                { name: "Jose Antonio", nim: "0000081618" },
                { name: "Maddava Arya", nim: "0000093678" },
                { name: "Cerina Kahayani", nim: "0000093822" },
                { name: "Nadine Starleen", nim: "0000092284" },
                { name: "Callista Feodora", nim: "0000101799" },
                { name: "Putri Videlia", nim: "0000109353" },
                { name: "Cassia Wulandari", nim: "0000108585" },
                { name: "Dennis Marcello", nim: "0000075159" },
                { name: "Nicky Puji", nim: "0000106285" },
                { name: "Adeline Gracia", nim: "0000099129" },
                { name: "Desmonda Felim", nim: "0000091507" },
                { name: "Chaterine Laurenthia", nim: "0000067669" },
                { name: "Nashaffa Novadhan", nim: "0000108838" },
                { name: "Bryant Sachio", nim: "0000092440" },
                { name: "Aurelia Keianne", nim: "0000095736" },
                { name: "Keira Nicole", nim: "0000089719" },
                { name: "Florence Callista", nim: "0000108171" },
                { name: "Kayla Nugroho", nim: "0000100585" },
                { name: "Lifkie Lie", nim: "0000081835" },
                { name: "Muhammad Kynan", nim: "0000088284" },
                { name: "Claditte Qisthidarari", nim: "0000089619" },
                { name: "Nicholas Nelson", nim: "0000087430" },
                { name: "Devina Setiawan", nim: "0000107896" },
                { name: "Chiara Andini", nim: "0000069039" },
                {name: "Varrel Noas", nim: "0000109877"},
                {name: "Michelle Angelina", nim: "0000093742"},
                {name: "Dennis Aaron", nim: "0000079897"},
                {name: "Aisyah Ayu", nim: "0000098252"},
                {name: "Naura Sita", nim: "0000099865"},
                {name: "Alya Geraldine", nim: "0000089178"},
                {name: "Livia Hadi", nim: "0000089038"},
                {name: "Putri Aurelia", nim: "0000107626"},
                {name: "Lovenia Kirana", nim: "0000069643"},
                {name: "Evelyn Valencia", nim: "0000092683"},
                {name: "Celine Grace", nim: "0000093278"},
                {name: "Fakhira Putri", nim: "0000113010"},
                {name: "Rahadina Adisty", nim: "00000106427"},
                {name: "Nicholas Kesuma", nim: "0000101382"},
                {name: "Felicia Jennifer", nim: "0000069537"},
                {name: "Vincentius Rafael", nim: "0000071271"},
                {name: "Brightly Virya", nim: "0000068227"},
                {name: "Angelina Alexander", nim: "0000079321"},
                {name: "Dicky Rusandana", nim: "0000080879"}
            ]            
        },
    ],
    "NAYANIKA": [
